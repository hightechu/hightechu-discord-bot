...
module.exports = {
    ...
    execute(message) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addFields(
                { name: 'HighTechU Skills Academy', value: 'Join us this summer for our 5th Cohort! Visit https://www.hightechu.ca for more information!' },
                { name: '\u200B', value: '\u200B' },
                { name: 'August Cohort', value: 'August 20th-21st', inline: true },
                { name: 'August Cohort', value: 'August 9th-10th', inline: true },
            )
            .setTimestamp()
